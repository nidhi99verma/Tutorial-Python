#isinstance fun ka kam check kerna hai ke kunsa sa oject kis class ka hai
class Phone:  
...
ph = Phone('nokia','1100',1000)
sm = Smartphone('oneplus','5',30000,'6GB','64GB','20MP')
fs = FlagshipPhone('oneplus','7T',40000,'10GB','225GB','30MP','20MP')

print(isinstance(fs,Phone))                          #(Object , Class)
print(isinstance(fs,Phone))
print(isinstance(fs,Smartphone))
print(isinstance(sm,FlagshipPhone))

#Phone <-- SmartPhone <-- FlagshipPhone
